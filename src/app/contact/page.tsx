...
export default function ContactPage() {
  ...
  const handleSubmit = (e: FormEvent) => {
    ...
    lines.push(`Subject: ${formData.subject}`, "", formData.message);
                ...
                {submitted ? (
                  <div className="text-center py-8">
                    ...
                    <p className="mt-2 text-muted">
                      We&apos;ve opened WhatsApp with your message, just tap send and we&apos;ll reply soon.
                    </p>
                    ...
                    <button onClick={() => { setSubmitted(false); setWaUrl(""); setFormData({ name: "", email: "", subject: "", message: "" }); }} className="mt-4 text-primary font-medium hover:text-primary-dark transition-colors">
