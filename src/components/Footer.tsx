          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-2">
                ...
                <a href="https://wa.me/94711114767" target="_blank" rel="noopener noreferrer" className="text-gray-400 text-sm hover:text-white transition-colors">071 111 4767</a>
              </li>
            </ul>
          </div>
        </div>
